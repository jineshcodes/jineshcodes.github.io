...
module Concurrent
  ...
  #
  # @see https://ruby-doc.org/core/Struct.html Ruby standard library `Struct`
  module MutableStruct
    ...
    #
    #   @see https://ruby-doc.org/core/Struct.html#method-c-new Ruby standard library `Struct#new`
